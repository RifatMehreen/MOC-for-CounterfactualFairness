...
MOCCounterfactualFairnessClassif = R6::R6Class("MOCCounterfactualFairnessClassif", inherit = CounterfactualFairnessMethodClassif,
  ...
  public = list(
   ...
   initialize = function(predictor, df, protected_column, row_num, predictor_protected = NULL, epsilon = NULL, fixed_features = NULL, max_changed = NULL, mu = 20L, 
   ...
   get_predictor_protected = function(df, protected_column, row_num){
  ...
  private = list(
   ...
   run = function() {
     ...
     private$.optimizer = moc_fairness_algo(
       ...
       df = private$df,
       protected_column = private$protected_column,
       row_num = private$row_num,
       predictor_protected = private$predictor_protected,
